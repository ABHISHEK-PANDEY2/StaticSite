...
import { ChangePassword } from 'configs/firebase.config'
...
const Password = ({ data }) => {
    const onFormSubmit = async (values, setSubmitting) => {
        ...
        if(result === 'Your Password is Updated' ){    
            toast.push(<Notification title={'Password updated'} type="success" />, {
                placement: 'top-center',
            })
        }else if(result === 'Please Enter the Correct Old Password'){
            toast.push(<Notification title={'Please Enter the Correct Old Password'} type="danger" />, {
                placement: 'top-center',
            })
        }else{
            toast.push(<Notification title={result} type="danger" />, {
                placement: 'top-center',
            })
        }
        setSubmitting(false)
